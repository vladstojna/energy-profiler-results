...
make -C "$EP_EVAL_PREFIX/lapacke" impl=intel-mkl USE_ITERATIONS=1 DO_COMPUTATION=1 remake
...
make -C "$EP_EVAL_PREFIX/lapacke" impl=intel-mkl USE_ITERATIONS=1 remake
